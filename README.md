...
## 更新日志
1. stable-1.1.1 (最新版本，更新于2023.08.08 UTC+8)
+ 完善了数据集缓存功能，同时加入缓存更新功能，使得在加载相同类型的数据集时获得更快的响应速度
+ 调整了角度训练的模型结构，相比之前有了更好的效果
2. stable-1.1.0 (更新于2023.07.28 UTC+8)
...
3. stable-1.0.2 (更新于2023.07.18 UTC+8)
+ 修复了读取 **settings.json** 文件无法同步的相关问题
4. stable-1.0.1 (更新于2023.07.17 UTC+8)
+ 修复了日志版本信息显示异常的相关问题
5. stable-1.0.0 (更新于2023.07.16 UTC+8)
+ 正式版本现在可以使用
<br><br>
