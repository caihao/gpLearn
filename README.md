...
3. stable-1.0.2 (更新于2023.07.18)
+ 修复了读取 **settings.json** 文件无法同步的相关问题
4. stable-1.0.1 (更新于2023.07.17)
+ 修复了日志版本信息显示异常的相关问题
5. stable-1.0.0 (更新于2023.07.16)
+ 正式版本现在可以使用
<br><br>
