...
from model.LinearNet_Res import LinearNet_Res
...
def initializeModel(model_name:str,input_channel:int,input_size_x:int,input_size_y:int,output_size:int,model_type:str,other_init_keys:list=None):
    ...
    elif model_type=="LinearNet_Res":
        model=LinearNet_Res(input_channel,input_size_x,input_size_y,output_size,init_weights=True)
