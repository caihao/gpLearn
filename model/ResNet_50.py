...
class ResNet_50(nn.Module):
    ...
    def __init__(self, block, layers, input_channal=1, output_size=2, zero_init_residual=False,
        ...
        #-----------------------------------#
        self.conv1 = nn.Conv2d(input_channal, self.inplanes, kernel_size=7, stride=2, padding=3,bias=False)
...
# F=torch.randn(16,1,128,128)
# print("As begin,shape:",format(F.shape))
# resnet=ResNet_50(Bottleneck,[3,4,6,3],input_channal=1)
# F=resnet(F)
# print(F.shape)
